...
public class CardRepository {
    ...
    private final String SQL_GET_CARDS_BY_USER_ID = "select * from cards c join merchants m on m.id = c.issued_by where c.user = ? and c.is_deleted = false and m.is_deleted = false order by c.updated_on limit ? offset ?";
